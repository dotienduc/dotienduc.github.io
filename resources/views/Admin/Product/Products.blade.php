...
<head>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.9/css/bootstrap-select.css" rel="stylesheet" />
        ...
        <div id="page-heading">
            ...
            <div class="options">
                ...
                <div class="btn-toolbar">
                    ...
                    <a href="{{ route('products.add') }}"><button class="btn btn-success"><i class="fa fa-plus-square" aria-hidden="true"></i></button></a>  
...
<script>
    $(document).ready(function(){
        ...
        $('#multi_search_filter').change(function(event) {
