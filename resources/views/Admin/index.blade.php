...
<head>
    ...
    <link rel='stylesheet' type='text/css' href='{{ url("admin/assets/plugins/fullcalendar/fullcalendar.css")}}' /> 
    <link rel='stylesheet' type='text/css' href='{{ url("admin/assets/plugins/form-markdown/css/bootstrap-markdown.min.css")}}' /> 
                ...
                <div class="widget-body collapse in" id="chatbody">
                    <ul class="chat-users">
                        ...
                        <li data-stats="away"><a href="javascript:;"><img src="{{ url('admin/assets/demo/avatar/jobs.png') }}" alt=""><span>Howard Jobs</span></a></li>
                            <!--li data-stats="offline"><a href="javascript:;"><img src="{{ url('admin/assets/demo/avatar/watson.png') }}" alt=""><span>Annie Watson</span></a></li>
                            <li data-stats="offline"><a href="javascript:;"><img src="{{ url('admin/assets/demo/avatar/doyle.png') }}" alt=""><span>Alan Doyle</span></a></li>
                            <li data-stats="offline"><a href="javascript:;"><img src="{{ url('admin/assets/demo/avatar/corbett.png') }}" alt=""><span>Simon Corbett</span></a></li>
                            <li data-stats="offline"><a href="javascript:;"><img src="{{ url('admin/assets/demo/avatar/paton.png') }}" alt=""><span>Polly Paton</span></a></li-->
                            </ul>
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-alizarin" href="#">
                                ...
                                <div class="tiles-body-alt">
                                    ...
                                    <div class="text-center" id="TongBill">0</div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12 clearfix">
                                    <h4 class="pull-left" style="margin: 0 0 20px;">User Report </h4>
                                </div>
                                <div class="col-md-12">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="threads">
                                    <ul class="panel-threads">
                                        <li>
                                            <img src="{{ url('admin/assets/demo/avatar/aniss.png') }}" alt="Aniss">
                                            <div class="content">
                                        ...
                                        <li>
                                            <img src="{{ url('admin/assets/demo/avatar/corbett.png') }}" alt="Corbett">
                                            <div class="content">
                                        ...
                                        <li>
                                            <img src="{{ url('admin/assets/demo/avatar/dangerfield.png') }}" alt="Dangerfield">
                                            <div class="content">
                                        ...
                                        <li>
                                            <img src="{{ url('admin/assets/demo/avatar/doyle.png') }}" alt="Doyle">
                                            <div class="content">
                                        ...
                                        <li>
                                            <img src="{{ url('admin/assets/demo/avatar/jackson.png') }}" alt="Jackson">
                                            <div class="content">
                                ...
                                <div class="tab-pane" id="comments">
                                    <ul class="panel-comments">
                                        ...
                                        <li>
                                            <img src="{{ url('admin/assets/demo/avatar/paton.png') }}" alt="Corbett">
                                            <div class="content">
                                                <span class="actions"><div class="options"><div class="btn-group"><button class="btn btn-default btn-xs"><i class="fa fa-pencil"></i></button><button class="btn btn-default btn-xs"><i class="fa fa-times"></i></button></div></div></span>
                                        ...
                                        <li>
                                            <img src="{{ url('admin/assets/demo/avatar/watson.png') }}" alt="Watson">
                                            <div class="content">
                                                <span class="actions"><div class="options"><div class="btn-group"><button class="btn btn-default btn-xs"><i class="fa fa-pencil"></i></button><button class="btn btn-default btn-xs"><i class="fa fa-times"></i></button></div></div></span>
                                ...
                                <div class="tab-pane" id="users">
                                    <ul class="panel-users">
                                        <li>
                                            <img src="{{ url('admin/assets/demo/avatar/paton.png') }}" alt="Paton">
                                            <div class="content">
                                        ...
                                        <li>
                                            <img src="{{ url('admin/assets/demo/avatar/tennant.png') }}" alt="Tennant">
                                            <div class="content">
                                        ...
                                        <li>
                                            <img src="{{ url('admin/assets/demo/avatar/jobs.png') }}" alt="Jobs">
                                            <div class="content">
...
<script type='text/javascript' src='{{ url("admin/assets/plugins/fullcalendar/fullcalendar.min.js") }}'></script> 
...
<script type='text/javascript' src='{{ url("admin/assets/plugins/pulsate/jQuery.pulsate.min.js") }}'></script> 
...
<script type="text/javascript">
    BillsPerMonth();
    function BillsPerMonth(){
        $.ajax({
            url: "{{ url('admin/ChartBill') }}",
            method: "GET",
            dataType : "json",
            success:function(q){
                drawChart(q);
    ...
    function drawChart(result){
        var month = result.data.map(function(e){
            return e.month;
        });
        var count = result.data.map(function(e){
            return e.Tong;
        });
        $('#TongBill').html(count);
